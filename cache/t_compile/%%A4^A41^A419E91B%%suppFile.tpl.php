<?php /* Smarty version 2.6.26, created on 2014-02-09 16:44:37
         compiled from submission/suppFile/suppFile.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'submission/suppFile/suppFile.tpl', 21, false),array('function', 'fieldLabel', 'submission/suppFile/suppFile.tpl', 30, false),array('function', 'form_language_chooser', 'submission/suppFile/suppFile.tpl', 35, false),array('function', 'translate', 'submission/suppFile/suppFile.tpl', 36, false),array('function', 'html_options_translate', 'submission/suppFile/suppFile.tpl', 67, false),array('modifier', 'escape', 'submission/suppFile/suppFile.tpl', 22, false),array('modifier', 'to_array', 'submission/suppFile/suppFile.tpl', 32, false),array('modifier', 'assign', 'submission/suppFile/suppFile.tpl', 32, false),array('modifier', 'date_format', 'submission/suppFile/suppFile.tpl', 131, false),)), $this); ?>
...
<div id="locales">
	<tr valign="top">
		...
		<td width="80%" class="value">
			<?php if ($this->_tpl_vars['suppFileId']): ?><?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editSuppFile','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['suppFileId']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['suppFileId'])),'from' => $this->_tpl_vars['from']), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'formUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'formUrl'));?>

			<?php else: ?><?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'addSuppFile','path' => $this->_tpl_vars['paperId'],'from' => $this->_tpl_vars['from'],'escape' => false), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'formUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'formUrl'));?>
...
<?php if ($this->_tpl_vars['suppFile']): ?>
	<tr valign="top">
		...
		<td width="80%" class="data"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['suppFile']->getFileId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['suppFile']->getFileId()))), $this);?>
