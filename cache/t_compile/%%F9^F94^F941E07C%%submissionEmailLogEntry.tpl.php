<?php /* Smarty version 2.6.26, created on 2014-02-09 17:14:57
         compiled from trackDirector/submissionEmailLogEntry.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'trackDirector/submissionEmailLogEntry.tpl', 18, false),array('function', 'translate', 'trackDirector/submissionEmailLogEntry.tpl', 18, false),array('function', 'icon', 'trackDirector/submissionEmailLogEntry.tpl', 62, false),array('modifier', 'date_format', 'trackDirector/submissionEmailLogEntry.tpl', 50, false),array('modifier', 'concat', 'trackDirector/submissionEmailLogEntry.tpl', 60, false),array('modifier', 'to_array', 'trackDirector/submissionEmailLogEntry.tpl', 61, false),array('modifier', 'assign', 'trackDirector/submissionEmailLogEntry.tpl', 61, false),array('modifier', 'escape', 'trackDirector/submissionEmailLogEntry.tpl', 62, false),array('modifier', 'nl2br', 'trackDirector/submissionEmailLogEntry.tpl', 93, false),)), $this); ?>
 ...
 <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => $this->_tpl_vars['url']), $this);?>
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<?php echo ((is_array($_tmp=$this->_tpl_vars['logEntry']->getFrom())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => $this->_tpl_vars['url']), $this);?>
...
<?php if ($this->_tpl_vars['isDirector']): ?>
	<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'clearSubmissionEmailLog','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getPaperId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['logEntry']->getLogId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['logEntry']->getLogId()))), $this);?>
...
<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submissionEmailLog','path' => $this->_tpl_vars['submission']->getPaperId()), $this);?>
