<?php /* Smarty version 2.6.26, created on 2014-02-09 17:09:26
         compiled from submission/comment/directorDecisionComment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'submission/comment/directorDecisionComment.tpl', 19, false),array('function', 'url', 'submission/comment/directorDecisionComment.tpl', 24, false),array('function', 'fieldLabel', 'submission/comment/directorDecisionComment.tpl', 59, false),array('modifier', 'date_format', 'submission/comment/directorDecisionComment.tpl', 20, false),array('modifier', 'to_array', 'submission/comment/directorDecisionComment.tpl', 24, false),array('modifier', 'escape', 'submission/comment/directorDecisionComment.tpl', 24, false),array('modifier', 'strip_unsafe_html', 'submission/comment/directorDecisionComment.tpl', 31, false),array('modifier', 'nl2br', 'submission/comment/directorDecisionComment.tpl', 31, false),)), $this); ?>
...
<tr valign="top">
	...
	<td width="75%">
		<?php if ($this->_tpl_vars['comment']->getAuthorId() == $this->_tpl_vars['userId'] && ! $this->_tpl_vars['isLocked']): ?>
			<div style="float: right"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'deleteComment','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['comment']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['comment']->getId()))), $this);?>
...
<?php if (! $this->_tpl_vars['isLocked'] && $this->_tpl_vars['isDirector']): ?>
