<?php /* Smarty version 2.6.26, created on 2014-01-27 23:21:33
         compiled from manager/announcement/announcementForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/announcement/announcementForm.tpl', 24, false),array('function', 'fieldLabel', 'manager/announcement/announcementForm.tpl', 34, false),array('function', 'form_language_chooser', 'manager/announcement/announcementForm.tpl', 39, false),array('function', 'translate', 'manager/announcement/announcementForm.tpl', 40, false),array('function', 'html_select_date', 'manager/announcement/announcementForm.tpl', 84, false),array('modifier', 'escape', 'manager/announcement/announcementForm.tpl', 26, false),array('modifier', 'assign', 'manager/announcement/announcementForm.tpl', 36, false),array('block', 'iterate', 'manager/announcement/announcementForm.tpl', 48, false),)), $this); ?>
...
<?php if (count ( $this->_tpl_vars['formLocales'] ) > 1): ?>
	<tr valign="top">
		...
		<td width="80%" class="value">
			...
			<?php else: ?><?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createAnnouncement'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'announcementUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'announcementUrl'));?>
...
<tr valign="top">
	<td width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'schedConfId','key' => "manager.announcements.form.schedConfId"), $this);?>
</td>
	<td width="80%" class="value"><select name="schedConfId" id="schedConfId" class="selectMenu">
		<option value="0"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.all"), $this);?>
</option>
		...
		<option value="<?php echo $this->_tpl_vars['schedConf']->getId(); ?>
"<?php if ($this->_tpl_vars['schedConfId'] == $this->_tpl_vars['schedConf']->getId()): ?> selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['schedConf']->getSchedConfTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</option>
		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> 
	</select></td>
</tr>
...
" class="button" onclick="document.location.href='<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'announcements'), $this);?>
'" /></p>
