    ...
    <div id="wrapper">
      ...
      <div id="contenido">
        ...
        <div id="listado_reportes">
            <h3>Reporte de preinscritos al evento</h3>
            <?php
            ...
            ?>
                <table width="100%">
                    <tr>
                        <td align="right">
                            <a href="../src/ExportPreinscritos.php?rep_format=pdf" target="_blank"><img height="50" width="50" src="../imgs/pdf.png" alt="Exportar a PDF"/></a>
                            <a href="../src/ExportPreinscritos.php?rep_format=xls" target="_blank"><img height="50" width="50" src="../imgs/excel.jpg" alt="Exportar a XLS"/></a>
                        </td>
                    </tr>
                </table>
                Total de preinscritos: <?php echo count($asistentes);?></br></br>
                <table width="100%">
                    <tr align="left">
            ...
            <?php } else { ?>
                <div class="nodata">NO HAY PREINSCRITOS PARA ESTE EVENTO</div>
            <?php } ?>
        </div>
      </div>
