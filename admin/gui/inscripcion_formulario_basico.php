            ...
            <form id="verificacion-email" method="POST" action="">
                <div class="step">
                    ...
                    <div class="step-content">
                        <p>Por favor ingresa el correo electr&oacute;nico con el cual deseas registrarte</p>
                        <p class="ingles">Please enter the email address with which you want to register</p>
                        <input type="text" name="email" id="email" size="20" class="formulario"/>
                        <input type="hidden" value="<?php echo $sched_conf_id ?>" name="sched_conf_id" />
                        <input type="submit" value="Verificar" class="boton" id="submit"/>
                    </div>
                </div>
            </form>
        </section>
