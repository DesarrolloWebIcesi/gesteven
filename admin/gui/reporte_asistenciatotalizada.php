           ...
           //print_r($presentaciones);
            ...
            ?>
                <table width="100%">
                    <tr>
                        <td align="right">
                            <a href="../src/ExportAsistotalizada.php?rep_format=pdf" target="_blank"><img height="50" width="50" src="../imgs/pdf.png" alt="Exportar a PDF"/></a>
                            <a href="../src/ExportAsistotalizada.php?rep_format=xls" target="_blank"><img height="50" width="50" src="../imgs/excel.jpg" alt="Exportar a XLS"/></a>
                        </td>
                    </tr>
                </table>
                <table width="100%">
                    ...
                    ?>
						...
						<tr class="tablerow<?php echo $i%2;?>">
                            ...
                            <td><a href="<?php echo 'reporte_asistentespon.php?paper_id='.$presentacion['paper_id'].'&amp;sched_conf_id='.$_SESSION['rsched_conf_id'].'&amp;titulo_ponencia='.$presentacion['nombre'];?>"><?php echo htmlentities($presentacion['nombre']) ?></a></td>
                            <td><center><?php echo htmlentities($presentacion['cantidad']) ?></center></td>
