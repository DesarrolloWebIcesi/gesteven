...
//			</script>";
    break;
  case 1:
    $return['msg'] = utf_encode("Su nombre de usuario no existe en la base de datos");
//			echo "<script languaje='Javascript'>
...
//			</script>";
    break;
  case 2:
    $return['msg'] = utf_encode("Nombre de usuario o contraseña incorrectos");
//			echo "<script languaje='Javascript'>
...
//			</script>";
    break;
  case 3:
    $return['msg'] = utf_encode("En este momento el sistema no está disponible. Por favor intente más tarde");
//			echo "<script languaje='Javascript'>
...
//			</script>";
    break;
  default:
    $return['msg'] = utf_encode("Error desconocido");
//			echo "<script languaje='Javascript'>
