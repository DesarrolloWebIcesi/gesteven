...
//			</script>";
    break;
  case 2:
    $return['msg'] = htmlentities("Nombre de usuario o contraseña incorrectos");
//			echo "<script languaje='Javascript'>
...
//			</script>";
    break;
  case 3:
    $return['msg'] = htmlentities("En este momento el sistema no está disponible. Por favor intente más tarde");
//			echo "<script languaje='Javascript'>
