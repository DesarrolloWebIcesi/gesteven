 ...
 * en PDF o EXCEL seg�n el parametr� enviado en la varible $_GET['rep_format'].
 *
...
switch ($formato) {
    case 'pdf':
        /**
         * Librearia para generai�n de PDF
         */
        ...
        $pdf->ezText("<b>SISTEMA DE GESTI�N DE EVENTOS</b>", 16, array('left' => 265));
        ...
        $titulos = array('codigo_barras' => '<b>Código de barras</b>','username' => '<b>Nombre de usuario</b>', 'nombre' => '<b>Nombre</b>', 'apellido' => '<b>Apellido</b>', 'correo' => '<b>Correo</b>');
    ...
    case 'xls':
        ...
        // Creando el formato para los t�tulos de las columnas
        ...
        $hoja_trabajo->write(0, 6, 'Tel�fono', $formato_titulo);
        $hoja_trabajo->write(0, 7, 'G�nero', $formato_titulo);
        $hoja_trabajo->write(0, 8, 'Organizaci�n/Universidad', $formato_titulo);
        $hoja_trabajo->write(0, 9, 'Tipo de inscripci�n', $formato_titulo);
        $hoja_trabajo->write(0, 10, 'Fecha de inscripci�n', $formato_titulo);
