...
switch ($formato) {
    case 'pdf':
        ...
        $pdf->ezText("Reporte de asistencia totalizada", 12, array('left' => 305));
        ...
        $titulos = array('nombre' => '<b>Título de la ponencia</b>', 'cantidad' => '<b>Asistentes</b>');
    ...
    case 'xls':
        ...
        $libro_trabajo->send("reporte_asistenciatotalizada.xls");

        // El nombre no puede ser muy largo porque no genera el XLS
        $nombre_hoja = "Reporte de asistentes totales";
        ...
        $hoja_trabajo->write(0, 0, 'Titulo de ponencia', $formato_titulo);
        $hoja_trabajo->write(0, 1, 'Asistentes', $formato_titulo);
        ...
        foreach ($datos as $asistente) {
            $hoja_trabajo->writeString($fila, 0, $asistente['nombre']);
            $hoja_trabajo->writeString($fila, 1, $asistente['cantidad']);
            $fila++;
        }
