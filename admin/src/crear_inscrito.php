...
if ($valido)
{
  ...
  if($_POST['tipo_inscripcion'] != null && $_POST['tipo_inscripcion'] != ""){
    $return = Evento::crearInscrito($_POST['tipo_inscripcion'], $_POST['nombre'], $_POST['apellidos'], $_POST['email'], $_POST['telefono'], $_POST['codigo_barras'], $_POST['sched_conf_id'], $_POST['username'], $_POST['transaccion'], $_POST['asignado'], $campos, $_POST['lugar'], $_POST['organizacion'], $_POST['genero']);
     ...
     /* Autor: cdcriollo 
	    Fecha: 2014-09-10
		Descripción: Se modifico el script para que dependiendo del tipo de inscripción que el usuario realice, se envie un correo notificando al usuario de si fue preinscrito o inscrito al evento */
	...
	if($return['error']== 0)
	{
		...
		if($_POST['transaccion'] != "I" )
		{
			...
			$mensaje_correo.="Estos datos han sido registrados en la base de datos de gestión de eventos de la Universidad Icesi para propósitos de estadísticas de asistencia a eventos académicos. Si desea que su información personal sea eliminada escriba un correo a midatopersonal@listas.icesi.edu.co ";
