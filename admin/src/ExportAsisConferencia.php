...
switch ($formato) {
    case 'pdf':
        ...
        $pdf->ezText("Reporte de asistentes al evento", 12, array('left' => 310));
    ...
    case 'xls':
        ...
        $hoja_trabajo->write(0, 2, 'Apellidos', $formato_titulo);
        $hoja_trabajo->write(0, 3, 'Correo', $formato_titulo);
        $hoja_trabajo->write(0, 4, 'Lugar', $formato_titulo);
        ...
        foreach ($datos as $asistente) {
            ...
            $hoja_trabajo->writeString($fila, 4, $asistente['mailing_address']);
