...
require_once("../lib/generadorxls/OLE/PPS/Root.php");
require_once("../lib/generadorxls/OLE/PPS/File.php");
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    {
        include_once(PATH_SERVIDOR_REAL."/paquetes/Spreadsheet/Writer/Validator.php");
