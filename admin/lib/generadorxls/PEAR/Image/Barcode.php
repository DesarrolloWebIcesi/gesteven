...
class Image_Barcode extends PEAR
{
    ...
    function draw($text, $type = 'int25', $imgtype = 'png') {
        ...
        $barcodepath = PATH_PAQUETE."/PEAR/Image/Barcode";
        ...
        if ( in_array($type . ".php", $supportedtypes) ) {
            include_once(PATH_PAQUETE."/PEAR/Image/Barcode/${type}.php");
        } else {
        ...
        if (!class_exists($classname)) {
            return PEAR::raiseError("Unable to include the ".PATH_PAQUETE."/PEAR/Image/Barcode/${type}.php file");
        }
